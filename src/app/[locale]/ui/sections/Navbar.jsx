...
export default function Navbar() {
  ...
  return (
      <nav className="bg-gray-white border-gray-200 dark:bg-gray-950 container">
        <div className="flex flex-wrap items-center justify-between  py-4">
                          ...
                          <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5">
                              <ul className="py-2 font-medium" role="none">
                                  <li onClick={() => changeLocale('en')}>
                                      <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
            ...
            <div
                  ...
                  id="navbar-cta"
              >
                <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-950 dark:border-gray-700">
                      <li onClick={toggleMenu}>
                        <Link
                            href="/"
                            locale={pathname.split('/')[1]}
                            className={`block py-2 px-3 md:p-0 ${pathname === `/${pathname.split('/')[1]}`
                      ...
                      <li onClick={toggleMenu}>
                        <Link
                            href="/contact"
                            locale={pathname.split('/')[1]}
                            className={`block py-2 px-3 md:p-0 ${pathname === `/${pathname.split('/')[1]}/contact`
                                    ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500'
                                    : 'text-gray-900 dark:text-white'
                                }`}
                            aria-current="page"
