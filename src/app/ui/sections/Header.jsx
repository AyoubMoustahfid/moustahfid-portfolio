        ...
        <div className="container py-14">
            <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div className="relative ms-4">
                    ...
                    <div>
                        <span className="text-blue-600">Hey There 👋 I am</span>
                    ...
                    <h6 className="text-gray-500 text-xl">Senior <span className="text-black">Frontend Developer</span></h6>
                    <p className="mt-3 text-base text-gray-800 dark:text-gray-400">Hand-picked professionals and expertly crafted components, designed for any kind of entrepreneur.</p>
