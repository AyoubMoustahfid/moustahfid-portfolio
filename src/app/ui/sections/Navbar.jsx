...
export default function Navbar() {
  return (
      <nav className="bg-gray-white border-gray-200 dark:bg-gray-900 container">
        <div className="flex flex-wrap items-center justify-between  py-4">
            <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                  <Image src={icon_logo} className="h-10 w-10"  alt="Flowbite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-950 dark:text-gray-50">Ayoubfolio</span>
            </Link>
